...
function revive_scripts() {
	wp_enqueue_style( 'fontLato', get_template_directory_uri() . '/assets/fonts/fontLato.css' );
	
	wp_enqueue_style( 'fontKarinaC', get_template_directory_uri() . '/assets/fonts/fontKarinaC.css' );
	
	wp_enqueue_style( 'fontKorinnaC', get_template_directory_uri() . '/assets/fonts/fontKorinnaC.css' );
