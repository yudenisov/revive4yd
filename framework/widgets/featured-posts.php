...
class revive_Featured_Posts extends WP_Widget {

	public function __construct() {
		parent::__construct(
			'revive_fp_cat', // Base ID
			__('ProtoPress Featured Posts by Category', 'revive'), // Name
			array( 'description' => __( 'Display your Featured Content, with a Thumbnail.', 'revive' ), ) // Args
		);
	}
	...
	if (isset($instance['title'])) :
 	...
 	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'Featured Articles', 'revive' );
		}
		...
		<label for="<?php echo $this->get_field_id( 'fcat' ); ?>"><?php _e( 'Category ID', 'revive' ); ?></label>
...
add_action( 'widgets_init', 'register_revive_f_widget' );  
function register_revive_f_widget() {  
    register_widget( 'revive_Featured_Posts' );  
}  
